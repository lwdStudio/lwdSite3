  ...
  return (
    <Layout pageTitle={pageTitle} pageType="Showcase" location={location}>
      ...
      <div className="md:container md:mx-auto p-4">
        <h1 className="text-3xl sm:text-5xl font-extrabold font-serif text-transparent bg-clip-text bg-gradient-to-br from-blue-400 to-blue-800 py-2">{pageTitle}</h1>
        <p className="px-4">Here are some work sample of my previous project.</p>
